...
NUM_MOST_FREQ_LETTERS = 6 # attempts this many letters per subkey
MAX_KEY_LENGTH = 8 # will not attempt keys longer than this
...
def main():
    ...
    ciphertext = '''mnbr firrf ztaii af vx meteq hal jzrvbz zulaq, qhsseey onyicinbh iyvnqío phw ko esflqsee hahx
